<template>
	<view class="uni-numbox">
		...
		<image class="numbox_icon" src="../../static/minus.png" @click="_calcValue('minus')"></image>
		<view class="numbox_text">{{inputValue}}</view>
		<image class="numbox_icon" src="../../static/add.png" @click="_calcValue('plus')"></image>
