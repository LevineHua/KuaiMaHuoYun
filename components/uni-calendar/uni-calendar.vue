		...
		<view class="uni-calendar__box">
			<view class="uni-calendar__wrapper">
				<view class="uni-calenda__content">
					...
					<swiper v-else class="uni-calendar__body" style="height: 400px;" :current="currentIndex" circular :vertical="slide === 'vertical' ? true : false" skip-hidden-item-layout :duration="duration" @animationfinish="animationfinish" @change="change">
